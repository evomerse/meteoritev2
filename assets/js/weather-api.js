...
export function getWeatherDescription(weatherCode) {
  const weatherDescriptions = {
    ...
    48: { description: 'Brouillard givrant', icon: '🌫' },
    51: { description: 'Bruine légère', icon: '🌦' },
    53: { description: 'Bruine modérée', icon: '🌦' },
    55: { description: 'Bruine dense', icon: '🌦' },
    61: { description: 'Pluie légère', icon: '🌧' },
    63: { description: 'Pluie modérée', icon: '🌧' },
    65: { description: 'Pluie forte', icon: '🌧' },
    71: { description: 'Chute de neige légère', icon: '🌨' },
    73: { description: 'Chute de neige modérée', icon: '🌨' },
    75: { description: 'Chute de neige forte', icon: '🌨' },
    77: { description: 'Grains de neige', icon: '🌨' },
    80: { description: 'Averses légères', icon: '🌦' },
    81: { description: 'Averses modérées', icon: '🌦' },
    82: { description: 'Averses violentes', icon: '⛈' },
    85: { description: 'Averses de neige légères', icon: '🌨' },
    86: { description: 'Averses de neige fortes', icon: '🌨' },
    95: { description: 'Orage', icon: '⛈' },
    96: { description: 'Orage avec grêle légère', icon: '⛈' },
    99: { description: 'Orage avec grêle forte', icon: '⛈' }
  };
